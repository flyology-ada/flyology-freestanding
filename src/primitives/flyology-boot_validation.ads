...
package Flyology.Boot_Validation
  with Pure,
       SPARK_Mode => On
is
   ...
   with Export,
        Convention    => C,
        External_Name => "flyology_memory_entry_is_valid",
        Post           =>
   ...
   with Export,
        Convention    => C,
        External_Name => "flyology_memory_entries_are_disjoint",
        Post           =>
   ...
   with Export,
        Convention    => C,
        External_Name => "flyology_topology_identities_are_distinct",
        Post           =>
   ...
   with Export,
        Convention    => C,
        External_Name => "flyology_executable_translation_is_valid",
        Post           =>
