...
package Flyology_Freestanding.Platform is
   ...
   type Full_Context is record
      ...
      Extended_State : Flyology_Freestanding.Interrupt_Frames.XSAVE_Area;
   end record
     with Convention => C,
          Alignment  => 64;
   ...
   for Full_Context use record
      ...
      Extended_State at 256 range 0 ..
        Flyology_Freestanding.Interrupt_Frames.XSAVE_Capacity * 8 - 1;
   end record;
   for Full_Context'Size use
     (256 + Flyology_Freestanding.Interrupt_Frames.XSAVE_Capacity) * 8;
