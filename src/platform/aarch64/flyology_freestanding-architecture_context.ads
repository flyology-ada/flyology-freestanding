...
package Flyology_Freestanding.Architecture_Context is
   ...
   with Import,
        Convention    => C,
        External_Name => "flyology_freestanding_context_switch";

   procedure Start
   with Import,
        Convention    => C,
        External_Name => "flyology_freestanding_context_start";

   procedure Dispatcher_Start
   with Import,
        Convention    => C,
        External_Name => "flyology_freestanding_dispatcher_context_start";
end Flyology_Freestanding.Architecture_Context;
