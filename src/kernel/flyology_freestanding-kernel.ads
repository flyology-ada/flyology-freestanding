...
package Flyology_Freestanding.Kernel is
   ...
   subtype Wait_Kind is Flyology_Freestanding.Wait_Arbitration_Model.Wait_Kind;
   subtype Wait_Resolution is Flyology_Freestanding.Wait_Arbitration_Model.Resolution;
   subtype Wait_Resolve_Status is
     Flyology_Freestanding.Wait_Arbitration_Model.Resolve_Status;
   subtype Tick is Flyology_Freestanding.Timer_Model.Tick;
   subtype Frequency is Flyology_Freestanding.Clock_Model.Frequency;
   subtype Timer_Cancel_Status is Flyology_Freestanding.Timer_Model.Cancel_Status;
   subtype Dispatching_Policy is Flyology_Freestanding.Preemption_Model.Policy_Kind;
   subtype Binder_Time_Slice is Flyology_Freestanding.Preemption_Model.Binder_Time_Slice;
   FIFO_Within_Priorities : constant Dispatching_Policy :=
     Flyology_Freestanding.Preemption_Model.FIFO_Within_Priorities;
   Round_Robin_Within_Priorities : constant Dispatching_Policy :=
     Flyology_Freestanding.Preemption_Model.Round_Robin_Within_Priorities;
   Cancelled : constant Timer_Cancel_Status := Flyology_Freestanding.Timer_Model.Cancelled;
   ...
   with Export, Convention => C,
        External_Name => "flyology_freestanding_kernel_prepare_environment";

   procedure Prepare_AP (Core : System.Address)
   with Export, Convention => C,
        External_Name => "flyology_freestanding_kernel_prepare_ap";

   procedure Dispatcher_Start (Core : System.Address)
   with Export, Convention => C,
        External_Name => "flyology_freestanding_dispatcher_start";
   ...
   with Export, Convention => C,
        External_Name => "flyology_freestanding_kernel_environment_complete";
