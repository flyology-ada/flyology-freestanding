...
package body Flyology_Freestanding.Conformance.Domains is
   ...
   with Import, Convention => C,
        External_Name => "flyology_freestanding_conformance_report_layout_pass";

   procedure Report_Query_Pass
   with Import, Convention => C,
        External_Name => "flyology_freestanding_conformance_report_query_pass";

   procedure Report_Inheritance_Pass
   with Import, Convention => C,
        External_Name => "flyology_freestanding_conformance_report_inheritance_pass";

   procedure Report_Heterogeneous_Pass
   with Import, Convention => C,
        External_Name => "flyology_freestanding_conformance_report_heterogeneous_pass";

   procedure Report_All_Core_Pass
   with Import, Convention => C,
        External_Name => "flyology_freestanding_conformance_report_all_core_pass";

   procedure Report_All_Core_Start_Failure
   with Import, Convention => C,
        External_Name => "flyology_freestanding_conformance_report_all_core_start_failure";

   procedure Report_All_Core_Done_Failure
   with Import, Convention => C,
        External_Name => "flyology_freestanding_conformance_report_all_core_done_failure";
   ...
   procedure Check_Live_Policies is
      ...
      begin
         ...
         Flyology_Freestanding.Console.Put_Line
   ...
   begin
      ...
      Flyology_Freestanding.Console.Put_Line ("FLYOLOGY:SCHEDULING:LIVE_POLICY:PASS");
...
end Flyology_Freestanding.Conformance.Domains;
