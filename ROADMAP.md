...
| M1 | in progress | Limine boots Ada elaboration and brings all requested CPUs online on both architectures at `-smp 1/4`. |
| M2 | not started | Policy-neutral per-core dispatch, checked task transitions, voluntary contexts, interrupt frames, and remote reschedule substrate. |
