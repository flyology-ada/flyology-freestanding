...
| --- | --- | --- |
| product structure | in progress ([review](docs/reviews/product-structure.md)) | Responsibility-owned runtime/library layout, real host and target Alire/GPR project graphs, stable capability profiles, exact clean-room inventories, and zero numbered development-stage names in maintained artifacts. |
