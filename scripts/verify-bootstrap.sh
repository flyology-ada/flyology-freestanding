...
FLYOLOGY_FREESTANDING_BOOT_VARIANT=last-chance scripts/build-bootstrap.sh x86_64
FLYOLOGY_FREESTANDING_BOOT_VARIANT=last-chance scripts/build-bootstrap.sh aarch64
