...
for marker in 'FLYOLOGY:ADA:ELABORATION:PASS' \
    ...
    'FLYOLOGY:M4:EXCEPTIONAL_PROTECTED_IMMEDIATE:PASS' \
    'FLYOLOGY:M4:EXCEPTIONAL_PROTECTED_QUEUED:PASS' \
    'FLYOLOGY:M4:EXCEPTION_ABORT_PROTECTED:PASS' \
    'FLYOLOGY:M4:EXCEPTIONAL_RENDEZVOUS:PASS' \
    'FLYOLOGY:M4:EXCEPTION_ABORT:PASS' \
    ...
    'FLYOLOGY:M4:ABORT_PROTECTED:PASS' \
    'FLYOLOGY:M4:COLLISION_STRESS:PASS' \
