...
rm -rf build/host-m6-domain
"$gprbuild" -q -P tests/host/m6_domain_tests.gpr
output=$(build/host-m6-domain/bin/m6_domain_tests)
printf '%s\n' "$output"

test "$output" = \
    'FLYOLOGY:M6:DOMAIN_MODEL:PASS:EDGES 39:HASH 18160326575195984137'
