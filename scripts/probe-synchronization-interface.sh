...
output_root="$repository/build/probes/synchronization"
interface_root="$repository/probes/synchronization/interfaces"
mkdir -p "$output_root"
...
for architecture in x86_64 aarch64; do
    ...
    scripts/toolchain.sh exec-at "$architecture" "$output" \
        "$target-gcc" -c "$repository/probes/synchronization/exception_probe.adb" \
    ...
    scripts/toolchain.sh exec-at "$architecture" "$output" \
        "$target-gcc" -c "$repository/probes/synchronization/base_protected_probe.adb" \
        ...
        -gnatec="$repository/config/restrictions/bootstrap.adc" \
    ...
    scripts/toolchain.sh exec-at "$architecture" "$output" \
        "$target-gcc" -c "$repository/probes/synchronization/protected_probe.adb" \
    ...
    scripts/toolchain.sh exec-at "$architecture" "$output" \
        "$target-gcc" -c \
        "$repository/probes/synchronization/protected_conditional_probe.adb" \
    ...
    scripts/toolchain.sh exec-at "$architecture" "$output" \
        "$target-gcc" -c \
        "$repository/probes/synchronization/protected_timed_probe.adb" \
    ...
    scripts/toolchain.sh exec-at "$architecture" "$output" \
        "$target-gcc" -c \
        "$repository/probes/synchronization/simple_rendezvous_probe.adb" \
    ...
    scripts/toolchain.sh exec-at "$architecture" "$output" \
        "$target-gcc" -c \
        "$repository/probes/synchronization/dynamic_priority_probe.adb" \
    ...
    scripts/toolchain.sh exec-at "$architecture" "$output" \
        "$target-gcc" -c \
        "$repository/probes/synchronization/conditional_rendezvous_probe.adb" \
    ...
    scripts/toolchain.sh exec-at "$architecture" "$output" \
        "$target-gcc" -c \
        "$repository/probes/synchronization/timed_rendezvous_probe.adb" \
    ...
    scripts/toolchain.sh exec-at "$architecture" "$output" \
        "$target-gcc" -c \
        "$repository/probes/synchronization/dynamic_task_probe.adb" \
    ...
    scripts/toolchain.sh exec-at "$architecture" "$output" \
        "$target-gcc" -c \
        "$repository/probes/synchronization/activation_failure_probe.adb" \
    ...
    scripts/toolchain.sh exec-at "$architecture" "$output" \
        "$target-gcc" -c \
        "$repository/probes/synchronization/absolute_delay_probe.adb" \
    ...
    scripts/toolchain.sh exec-at "$architecture" "$output" \
        "$target-gcc" -c \
        "$repository/probes/synchronization/selective_wait_probe.adb" \
    ...
    scripts/toolchain.sh exec-at "$architecture" "$output" \
        "$target-gcc" -c "$repository/probes/synchronization/abort_probe.adb" \
    ...
    scripts/toolchain.sh exec-at "$architecture" "$output" \
        "$target-gcc" -c \
        "$repository/probes/synchronization/abort_dynamic_probe.adb" \
    ...
    scripts/toolchain.sh exec-at "$architecture" "$output" \
        "$target-gcc" -c "$repository/probes/synchronization/task_root_probe.adb" \
    ...
    echo "FLYOLOGY:RTS:PROBE:PASS:$architecture"
done
...
echo 'FLYOLOGY:RTS:PROBE:PASS:native-free-task'
