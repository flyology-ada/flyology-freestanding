...
output_directory=${FLYOLOGY_FREESTANDING_DISK_OUTPUT_DIRECTORY:-"build/bootstrap/$architecture"}
image="$output_directory/flyology-freestanding-$architecture.fat"
mtools_root=${FLYOLOGY_FREESTANDING_MTOOLS_ROOT:-/opt/homebrew/bin}
