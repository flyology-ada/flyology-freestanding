...
test "$(count_marker 'FLYOLOGY:RTS:EXCEPTION:PASS')" -eq 1
test "$(count_marker 'FLYOLOGY:LAST_CHANCE:')" -eq 0
test "$(count_marker 'FLYOLOGY:RTS:EXCEPTION:DETAIL:')" -eq 0
...
echo "FLYOLOGY:RTS:EXCEPTION_TEST:PASS:$architecture:SMP$cpu_count"
